...
y_all['number of visits quintile'] = pd.qcut(x=y_all['num_visits_after'], q=5, labels=False)
...
for i in range(5):
  ...
  min_val = temp['num_visits_after'].min()
  max_val = temp['num_visits_after'].max()
...
make_UMAP_violin_plots(X_embedded=X_embedded, 
                       ...
                       palette='tab10',
                       save=True,
                       filename_UMAP_1='fx_umap_visits_aft_violin1',
                       filename_UMAP_2='fx_umap_visits_aft_violin2')
...
if pvalue_1 < 0.05:
  ...
  if save_dunn:
    ...
    dunn.to_csv("male_infertility_validation/tables/umap/dunns_test/dunn_visits_after_axis1.csv")
    print('Saved.\n')
if pvalue_2 < 0.05:
  ...
  if save_dunn:
    ...
    dunn.to_csv("male_infertility_validation/tables/umap/dunns_test/dunn_visits_after_axis2.csv")
    print('Saved.')
