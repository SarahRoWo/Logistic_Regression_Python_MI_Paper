...
all_demo_df = pd.read_pickle("male_infertility_validation/tables/umap/demo_all_before.pkl")
...
make_UMAP_violin_plots(X_embedded=X_embedded, 
                       ...
                       palette=['hotpink', 'dodgerblue'], 
                       save=True,
                       filename_UMAP_1='fx_umap_mi_b4_violin1',
                       filename_UMAP_2='fx_umap_mi_b4_violin2')
