...
primary_vs_crude['ln_OR_has_phenotype_crude'].min()
...
plt.legend(loc=(0.02,0.736), fontsize=14)

if save:
  print('Saving ln-ln plot...')
  plt.savefig("male_infertility_validation/revision_files/fx_vs_crude_aft_ln.pdf", format='pdf', dpi=300, bbox_inches='tight')
  print('Saved.')
...
ax = sns.scatterplot(data=primary_vs_sdoh, x='ln_OR_has_phenotype_primary', y='ln_OR_has_phenotype_sdoh', s=20, hue='sig_overlap', hue_order=['not_significant', 'mi_sig_primary', 'mi_sig_sdoh', 'mi_sig_both', 'con_sig_primary', 'con_sig_both'], palette=['whitesmoke', 'hotpink', 'pink', 'purple', 'dodgerblue', 'midnightblue'], alpha=0.4)
...
if save:
  print('Saving ln-ln plot...')
  plt.savefig("male_infertility_validation/revision_files/fx_vs_sdoh_aft_ln.pdf", format='pdf', dpi=300, bbox_inches='tight')
  print('Saved.')
...
ax = sns.scatterplot(data=primary_vs_hosp, x='ln_OR_has_phenotype_primary', y='ln_OR_has_phenotype_hosp', s=20, hue='sig_overlap', hue_order=['not_significant', 'mi_sig_primary', 'mi_sig_both', 'con_sig_hosp', 'con_sig_both'], palette=['whitesmoke', 'hotpink', 'purple', 'powderblue', 'midnightblue'], alpha=0.4)
...
plt.legend(loc=(0.02,0.782), fontsize=14)

if save:
  print('Saving ln-ln plot...')
  plt.savefig("male_infertility_validation/revision_files/fx_vs_hosp_aft_ln.pdf", format='pdf', dpi=300, bbox_inches='tight')
  print('Saved.')
